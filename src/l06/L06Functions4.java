...
public class L06Functions4
{
	...
	public static void main(String[] args)
	{
		...
		//Overloaded Functions: Same method name, different parameters
		...
		int maxNum3 = findmax(num1, num2, num3); // function call
		System.out.println("The maximum of " + num1 + ", " + num2 + " and " + num3 + " is " + maxNum3);
		int maxNum4 = findmax(num1, num2, num3); // function call
		System.out.println("The maximum of " + num1 + ", " + num2 + " and " + num3 + " is " + maxNum4);
		int maxNum5 = findmax(maxNum3, maxNum4, num1); // function call
		System.out.println("maxNum5 is: " + maxNum5);
		int maxNum6 = findmax(findmax(num1,num2,num3), maxNum4, num1); // function call
		System.out.println("maxNum6 is: " + maxNum6);
		double dNum1, dNum2;
		dNum1 = 7.4;
		dNum2 = 3.19;
		System.out.println("The maximum of: " + dNum1 + " and " + dNum2 + " is " + findMax(dNum1, dNum2));
	...
	static double findMax(double d1, double d2)
	{
		...
		static int findmax(int num1, int num2, int num3) // static method, function head
		{
